...
const base = (js, css, html, dev) => {
  ...
  if (dev.dashboard && process.env.NODE_ENV !== 'production') {
...
function createCommon(obj = sweetpack) {
  ...
  obj = Object.assign({}, sweetpack, obj);
  ...
  return Object.assign({}, base(obj.js, obj.css, obj.html, obj.dev), {
    entry,
    output: {
      path: pathname,
